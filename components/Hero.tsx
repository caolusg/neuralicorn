...
const Hero: React.FC = () => {
  ...
  const heroContentOffsetClass = language === 'zh' ? 'pb-20 md:pb-28' : 'pb-16 md:pb-20';
  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content - Centered */}
      <div className={`relative z-10 max-w-6xl mx-auto px-6 text-center ${heroContentOffsetClass}`}>
